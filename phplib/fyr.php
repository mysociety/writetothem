 ...
 *
 * $Id: fyr.php,v 1.75 2009-12-11 16:30:00 matthew Exp $
 * 
 */
...
function fyr_display_advert($values) {
    ...
    if (array_key_exists('sender_email', $values)) {
        $adverts = array(
                ...
                array('demclub0', '<h2 style="margin-bottom:0">Help make the next election the most accountable ever</h2> <p style="font-size:120%;margin-top:0;"><a href="http://www.democracyclub.org.uk/">Join Democracy Club</a> and have fun keeping an eye on your election candidates.'),
        );
