...
function fyr_describe_area_type_list($area_types) {
    ...
    $ordered_descs_array = array(
        ...
        '<abbr title="Members of the Senedd">MSs</abbr>' => array('WAC'),
    );
...
function fyr_display_advert($values) {
    ...
    if (array_key_exists('sender_email', $values)) {
        $adverts = array(
                ...
                array('fms0', '<p>Got a local problem like potholes or flytipping in your street?<br><a href="https://www.fixmystreet.com/">Report it at FixMyStreet</a></p>'),
