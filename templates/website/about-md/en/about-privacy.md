WriteToThem is run by the charity [mySociety](https://www.mysociety.org/).
...
We hope it covers everything you need to know, but if you still have any questions please feel free to [contact us](/about-contact).
...
- We use a subprocessor called [Exoscale](https://www.exoscale.com/) to help analyse survey data. This involves the use of LLMs to anonymise free-text survey responses and label clusters of responses. It does not include the content of messages sent through WriteToThem. Exoscale provides access to specialist computer hardware to enable running open-weight LLMs without logging/storage or use of information for training. We are satisfied that Exoscale’s [security approach](https://www.exoscale.com/security/) and [data processing agreement](https://www.exoscale.com/dpa/) meet our standards for secure and GDPR-compliant processing of personal information.
...
As part of the process of sending your message to your representative we will send you a limited number of emails, as described above. If during this process you wish to stop receiving emails from us, or you are a representative who no longer wishes to receive email via WriteToThem*, please [contact us](/about-contact).

* If you are a representative wishing to opt out of WriteToThem, we encourage you to think again! WriteToThem is a system which makes it simple for your constituents to contact you, where they might find other channels more difficult to access. We have measures in place that prevent bulk mailings and contact with representatives other than the constituents’ own. You may wish to read more about the service and how you can best use it at [https://www.mysociety.org/mp-services/](https://www.mysociety.org/mp-services/).
...
You may [contact us](/about-contact) at any time to ask to see what personal data we hold about you.

### Your right to object

The General Data Protection Regulation gives you the right to object to our processing of your personal information and to ask us to stop processing it. However, it also gives us the right to continue to process it if we can demonstrate compelling legitimate grounds for the processing that override your interests, rights and freedoms. To exercise your right to object, you can [contact us](/about-contact), giving specific reasons why you are objecting to the processing of your personal data. These reasons should be based upon your particular situation.

### Your right to complain

If you believe that we have mishandled your data, you have the right to lodge a complaint with the Information Commissioner’s Office. [You can report a concern here](https://ico.org.uk/concerns/handling/) (but do contact us first, so that we can try and help).

### Who we are

WriteToThem is run by [mySociety](https://www.mysociety.org/), a UK not-for-profit social enterprise. Our registered address is:
...
…and we can also be [contacted here](/about-contact).
...
Bits of wording taken from the [GOV.UK cookies page](http://gov.uk/help/cookies) (under the Open Government Licence).
