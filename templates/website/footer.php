        ...
        <div class="row">
            ...
            <div class="large-5 columns">
                <div class="mysoc-footer__orgs">
                    ...
                    <?php
                        $url = "https://www.mysociety.org?utm_source=writetothem.com&amp;utm_content=footer+logo&amp;utm_medium=link&amp;utm_campaign=mysoc_footer";
                        printf(_('Built by <a href="%s" class="mysoc-footer__org__logo mysoc-footer__org__logo--mysociety">mySociety</a>'), $url)
                    ?>
                    </p>
                </div>
            </div>
            ...
            <div class="large-4 columns">
                <div class="mysoc-footer__legal">
                    ...
                    <p>
                    <?php
                        $mysociety_link = "https://www.mysociety.org?utm_source=writetothem.com&amp;utm_content=footer+full+legal+details&amp;utm_medium=link&amp;utm_campaign=mysoc_footer";
                        $societyworks_link = "https://www.societyworks.org?utm_source=writetothem.com&amp;utm_content=footer+full+legal+details&amp;utm_medium=link&amp;utm_campaign=mysoc_footer";
                        printf(_('<a href="%s">mySociety</a> is a registered charity in England and Wales (1076346) and a limited company (03277032). We provide commercial services through our wholly owned subsidiary <a href="%s">SocietyWorks Ltd</a> (05798215).'), $mysociety_link, $societyworks_link );
                    ?>
                    </p>
                </div>
            </div>
