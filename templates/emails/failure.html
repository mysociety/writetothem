...
<?= $recipient_name ?>, your <?= $recipient_position ?>.</p>
  <p style="<?= $p_style ?>">Unfortunately, sometimes emails can’t get through. It might be down to a server problem at the other end, or something unexpected in our system – we’ll look into it.</p>
  <p style="<?= $p_style ?>">Meanwhile, we’ve attached a copy of your letter to the bottom of this email, so that you can print it out and send it by other means. Or, try again via our site in a week or so – hopefully we’ll have tracked down the problem by then.</p>
