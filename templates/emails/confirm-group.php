...
$recipient_position_plural = 'local councillors';
$recipient_names_list = 'Alice White, Bob Black, and Carol Cream';
...
?><th style="<?= $td_style ?> <?= $primary_column_style ?>">
  ...
  <h1 style="<?= $h1_style ?>">Please confirm your letter to your <?= $recipient_position_plural ?>.</h1>
  <p style="<?= $p_style ?>">Someone just used <a href="https://www.writetothem.com">WriteToThem.com</a> to write a letter to <?= $recipient_names_list ?>, from your email account.</p>
...
<th style="<?= $td_style ?> <?= $secondary_column_style ?>">
  <h2 style="<?= $h2_style ?>">Your letter to <?= $recipient_names_list ?></h2>
  <p style="<?= $p_style ?>">Dear Councillors,</p>
