...
?><th style="<?= $td_style ?> <?= $primary_column_style ?>">
  ...
  <h1 style="<?= $h1_style ?>">Please confirm your letter to <?= $recipient_name ?>.</h1>
  <p style="<?= $p_style ?>">Someone just used <a href="https://www.writetothem.com">WriteToThem.com</a> to write a letter to <?= $recipient_name ?>, from your email account.</p>
