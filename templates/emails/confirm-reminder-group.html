...
?><th style="<?= $td_style ?> <?= $primary_column_style ?>">
  ...
  <h1 style="<?= $h1_style ?>">Last chance to confirm your letter to your <?= $recipient_position_plural ?>.</h1>
  <p style="<?= $p_style ?>"><?= $time_ago ?>, someone used <a href="https://www.writetothem.com">WriteToThem.com</a> to write a letter to <?= $recipient_names_list ?>, from your email account.</p>
