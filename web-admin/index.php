 ...
 *
 * $Id: index.php,v 1.26 2009-11-02 13:58:35 matthew Exp $
 * 
 */
...
EOF
    ...
    new ADMIN_PAGE_REPS,
    OPTION_ADMIN_SERVICES_CGI ? new ADMIN_PAGE_EMBED('fyrmatch', 'Councillor Data', OPTION_ADMIN_SERVICES_CGI . 'match.cgi') : null,
